 ...
 * @endcode
 */
$settings['hash_salt'] = 'ksvknk6aI6CtJBonsQO_QhwtHRMJu2cKoXLxxUatq-p-GCyVQaBPWQHG8UWVFWm_1oe84RY2fw';
...
$settings['install_profile'] = 'ddd';
$config_directories['sync'] = 'sites/default/files/config_fsGx03IZWnvfJ0273iPIdDHnYxqBwH2DEb435uW9Cn9eBuoUczu99SEPm7EU390-T5v8VU_k3w/sync';

if (file_exists(__DIR__ . '/settings.local.php')) {
include_once __DIR__ . '/settings.local.php';
}

$config['recaptcha.settings']['site_key'] = '6Le5xBETAAAAAO_kf_OUyBQ4VBJbuFkusjqO4sTt';
$config['recaptcha.settings']['secret_key'] = '6Le5xBETAAAAAD4_P-q7pyt2jfB9DjzH2f6qf8E8';
$config['ddd_attendees.settings']['authorization'] = 'S7ZP35YUS5OAQNA2G67B';
$config['ddd_attendees.settings']['event'] = '20033003252';
